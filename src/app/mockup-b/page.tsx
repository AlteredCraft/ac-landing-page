...
export default function MockupB() {
  return (
    <div className="min-h-screen bg-[var(--color-base)]" style={{
      '--color-base': '#F5F3EF',
      '--color-text': '#1F1D1D',
      '--color-accent': '#D4B84A',
      '--color-accent-hover': '#C4A83A',
      '--color-muted': '#8A877E',
      '--color-border': '#E0DDD6',
      ...
      <nav className="fixed top-0 left-0 right-0 py-5 px-6 lg:px-12 flex justify-between items-center bg-[var(--color-base)] z-50">
        <BrandLockup variant="horizontal" size="sm" theme="light" />
      ...
      <main>
        ...
        <section className="min-h-screen flex flex-col justify-center pt-24 pb-16 px-6 lg:px-12 max-w-[1000px] mx-auto">
          <h1 className="font-[family-name:var(--font-plus-jakarta)] font-bold text-[clamp(3rem,8vw,5rem)] leading-[1.05] uppercase tracking-tight mb-8">
        ...
        <section id="offerings" className="py-24 px-6 lg:px-12 max-w-[1400px] mx-auto">
          <div className="grid lg:grid-cols-[200px_1fr] gap-8 lg:gap-16 mb-12 items-end">
            <span className="font-[family-name:var(--font-plus-jakarta)] font-semibold text-sm uppercase tracking-widest text-[var(--color-muted)]">
              Offerings
            </span>
            <h2 className="font-[family-name:var(--font-plus-jakarta)] font-bold text-[clamp(2rem,4vw,3rem)] uppercase leading-tight">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-6">
            {OFFERINGS.map((offering) => (
              ...
              >
                ...
                <h3 className="font-[family-name:var(--font-plus-jakarta)] font-bold text-xl uppercase mb-2">
                  {offering.title}
                </h3>
        ...
        <section id="newsletter" className="py-24 px-6 lg:px-12 bg-[var(--color-surface)]">
          <div className="max-w-[1400px] mx-auto">
            <div className="grid lg:grid-cols-[200px_1fr] gap-8 lg:gap-16">
              ...
              <div>
                <h2 className="font-[family-name:var(--font-plus-jakarta)] font-bold text-[clamp(2rem,4vw,3rem)] uppercase leading-tight mb-4">
                  Stay calibrated
                </h2>
                ...
                <div className="grid md:grid-cols-2 gap-8 mb-12">
                  <div className="p-8 bg-[var(--color-base)]">
                    ...
                    <h3 className="font-[family-name:var(--font-plus-jakarta)] font-bold text-2xl uppercase mb-2">
                      Monday AI Review
                    </h3>
        ...
        <section id="teams" className="py-24 px-6 lg:px-12 bg-[var(--color-text)] text-[var(--color-surface)]">
          <div className="max-w-[1400px] mx-auto">
            <div className="text-center mb-16">
              <h2 className="font-[family-name:var(--font-plus-jakarta)] font-bold text-[clamp(2rem,4vw,3rem)] uppercase">
                For Teams
              </h2>
            ...
            <div className="grid lg:grid-cols-2 gap-8">
              ...
              <div className="p-10 bg-white/5 border border-white/10">
                <h3 className="font-[family-name:var(--font-plus-jakarta)] font-bold text-[1.75rem] uppercase mb-2">
                  Workshops
                </h3>
                <p className="text-[var(--color-muted)] mb-4">
        ...
        <section id="about" className="py-24 px-6 lg:px-12 bg-[var(--color-surface)]">
          <div className="max-w-[1400px] mx-auto">
            <div className="grid lg:grid-cols-[200px_300px_1fr] gap-8 lg:gap-16">
              ...
              {/* Bio */}
              <div>
                <h2 className="font-[family-name:var(--font-plus-jakarta)] font-bold text-3xl uppercase mb-6">
                  Sam Keen
                </h2>
